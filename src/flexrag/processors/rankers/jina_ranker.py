...
@configure
class JinaRankerConfig(RemoteRankerBaseConfig):
    """Configuration for JinaRankerConfig.

    :param model: The model to use. Default is "jina-reranker-v3".
    :type model: str
    :param base_url: The base URL of the Jina rerank API. Default is "https://api.jina.ai/v1/rerank".
    :type base_url: str
    :param api_key: The API key for the Jina rerank API.
...
class JinaRanker(RemoteRankerBase):
    async def _create_client(self, config: JinaRankerConfig):
