...
if __name__ == "__main__":
    ...
    testdata = [
        ...
        for i in open(
            os.path.join(
                "/data/zhangzhuocheng/Lab/Python/LLM/datasets/RAG/flash_rag",
                args.data_name,
                "test.jsonl",
            ),
            "r",
    ...
    with open(
        os.path.join(
            "/data/zhangzhuocheng/Lab/Python/LLM/inference/kylin",
            f"{args.data_name}_kylin@10_acc.json",
        ),
        "w",
    ) as f:
